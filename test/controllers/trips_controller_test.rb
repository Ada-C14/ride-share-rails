...
describe TripsController do
  ...
  describe "show" do
    ...
    it 'responds with success when showing an existing valid trip' do
      fake_passenger = Passenger.create(id: 20, name: 'CheezItMan', phone_num: '123-456-7890')
      fake_driver = Driver.create(id: 57, name: 'Devin', vin: '98765445678912345', available: true)
      fake_trip = Trip.create(id: 13, driver_id: fake_driver.id, passenger_id: fake_passenger.id, date: Date.today, rating: nil, cost: 25)
  ...
  describe "edit" do
    # Your tests go here
    passenger = Passenger.create(name: 'Jonah', phone_num: '123-7890')
    driver = Driver.create(name: 'Snowy', vin: '12341239876754345', available: true)
    old_trip = Trip.create(driver_id: driver.id, passenger_id: passenger.id, date: Date.today, rating: nil, cost: 70)
  ...
  describe "destroy" do
    ...
    it "Deletes an instance of trip and redirects" do
      ...
      fake_passenger = Passenger.create(id: 2, name: 'Alanis', phone_num: '123-456-7890')
      fake_driver = Driver.create(id: 7, name: 'Pitrico', vin: '09876543212345678', available: true)
